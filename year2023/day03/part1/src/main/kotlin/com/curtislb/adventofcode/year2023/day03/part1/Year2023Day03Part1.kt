...
symbol, even diagonally, is a "part number" and should be included in your sum. (Periods (`.`) do
...
package com.curtislb.adventofcode.year2023.day03.part1
...
/**
 * Returns the solution to the puzzle for 2023, day 03, part 1.
 *
