...
two hands of the same type, `J` is always treated as `J`, not the card it's pretending to be:
...
/**
 * Returns the solution to the puzzle for 2023, day 7, part 2.
 *
 * @param inputPath The path to the input file for this puzzle.
 */
fun solve(inputPath: Path = Paths.get("..", "input", "input.txt")): Long {
    val hands = inputPath.toFile().mapLines { Hand.fromString(it, useJokerRule = true) }
