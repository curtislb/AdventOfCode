...
each hand. A hand consists of five cards labeled one of `A`, `K`, `Q`, `J`, `T`, 9, 8, 7, 6, 5, 4,
3, or 2. The relative strength of each card follows this order, where `A` is the highest and 2 is
the lowest.
...
package com.curtislb.adventofcode.year2023.day07.part1

import com.curtislb.adventofcode.common.io.mapLines
import com.curtislb.adventofcode.year2023.day07.cards.Hand
import java.nio.file.Path
import java.nio.file.Paths

/**
 * Returns the solution to the puzzle for 2023, day 7, part 1.
 *
 * @param inputPath The path to the input file for this puzzle.
 */
fun solve(inputPath: Path = Paths.get("..", "input", "input.txt")): Long {
    val hands = inputPath.toFile().mapLines { Hand.fromString(it, useJokerRule = false) }
    return hands.sorted().withIndex().sumOf { (index, hand) -> hand.bid * (index + 1).toLong() }
}
