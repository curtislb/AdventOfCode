...
In this example, if the Elf's goal was to get exactly 6 more steps today, he could use them to reach
any of 16 garden plots.
...
import com.curtislb.adventofcode.year2023.day21.garden.GardenPlotGrid
import java.nio.file.Path
import java.nio.file.Paths

/**
 * Returns the solution to the puzzle for 2023, day 21, part 1.
 *
 * @param inputPath The path to the input file for this puzzle.
 * @param stepCount The exact number of remaining steps the Elf must walk.
 */
fun solve(inputPath: Path = Paths.get("..", "input", "input.txt"), stepCount: Int = 64): Int {
    val gardenPlotGrid = GardenPlotGrid.fromFile(inputPath.toFile())
    return gardenPlotGrid.countReachableInBaseGrid(stepCount)
}
