...
/**
 * Returns the solution to the puzzle for 2023, day 17, part 1.
 *
 * @param inputPath The path to the input file for this puzzle.
 * @param maxStraightDistance The maximum number of blocks through which the crucible can travel in
 *  a straight line before it must turn left or right.
 */
fun solve(
    inputPath: Path = Paths.get("..", "input", "input.txt"),
    maxStraightDistance: Int = 3
): Long? {
    val cruciblePath = CruciblePath.fromFile(inputPath.toFile(), maxStraightDistance)
