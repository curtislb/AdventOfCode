...
up (`U`), down (`D`), left (`L`), or right (`R`), clearing full 1 meter cubes as they go. The
...
package com.curtislb.adventofcode.year2023.day18.part1

import com.curtislb.adventofcode.common.io.mapLines
import com.curtislb.adventofcode.year2023.day18.dig.DigPlan
import com.curtislb.adventofcode.year2023.day18.dig.Instruction
import java.nio.file.Path
import java.nio.file.Paths

/**
 * Returns the solution to the puzzle for 2023, day 18, part 1.
 *
 * @param inputPath The path to the input file for this puzzle.
 */
fun solve(inputPath: Path = Paths.get("..", "input", "input.txt")): Long {
    val instructions = inputPath.toFile().mapLines { Instruction.fromString(it) }
    val digPlan = DigPlan(instructions)
