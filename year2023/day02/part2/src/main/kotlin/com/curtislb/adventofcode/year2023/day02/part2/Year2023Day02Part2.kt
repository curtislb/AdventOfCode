...
package com.curtislb.adventofcode.year2023.day02.part2
...
/**
 * Returns the solution to the puzzle for 2023, day 2, part 2.
 *
...
fun solve(inputPath: Path = Paths.get("..", "input", "input.txt")): Long {
    ...
    return games.sumOf { it.findMinPossibleColorCounts().counts.product() }
}
