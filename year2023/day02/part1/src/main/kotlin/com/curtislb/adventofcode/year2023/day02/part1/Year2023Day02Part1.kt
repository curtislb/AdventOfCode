...
package com.curtislb.adventofcode.year2023.day02.part1

import com.curtislb.adventofcode.common.collection.Counter
import com.curtislb.adventofcode.common.io.mapLines
import com.curtislb.adventofcode.year2023.day02.cubes.CubeGame
import java.nio.file.Path
import java.nio.file.Paths

/**
 * Returns the solution to the puzzle for 2023, day 2, part 1.
 *
 * @param inputPath The path to the input file for this puzzle.
 * @param colorCounts A map from each possible color to the number of cubes of that color that may
 *  have been in the bag.
 */
fun solve(
    inputPath: Path = Paths.get("..", "input", "input.txt"),
    colorCounts: Map<String, Long> = mapOf("red" to 12L, "green" to 13L, "blue" to 14L)
): Int {
    val games = inputPath.toFile().mapLines { CubeGame.fromString(it) }
    val counter = Counter.fromMap(colorCounts)
    return games.sumOf { if (it.isPossible(counter)) it.id else 0 }
}
