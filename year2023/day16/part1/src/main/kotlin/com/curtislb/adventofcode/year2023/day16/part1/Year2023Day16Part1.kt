...
/**
 * Returns the solution to the puzzle for 2023, day 16, part 1.
 *
 * @param inputPath The path to the input file for this puzzle.
 * @param beamStart The initial position and direction of the beam.
 */
fun solve(
    inputPath: Path = Paths.get("..", "input", "input.txt"),
    beamStart: Pose = Pose(Point.ORIGIN, Direction.RIGHT)
): Int {
    val contraption = BeamContraption.fromFile(inputPath.toFile())
    return contraption.beamEnergy(beamStart)
}
