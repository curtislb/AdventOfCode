...
/**
 * Returns a map from the pairs given by applying the [transform] function to each element in the original collection.
 */
@Generated
...
/**
 * Returns a map from the pairs given by applying the [transform] function to each entry in the original map.
 */
@Generated
