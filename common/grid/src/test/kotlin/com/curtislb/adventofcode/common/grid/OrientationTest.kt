...
class OrientationTest {
    ...
    fun testMoveForwardZeroDistance() {
        assertEquals(
            ...
            Orientation(Point(-16, -15), Direction.UP).move(distance = 0)
        )
        assertEquals(
            Orientation(Point(16, -9), Direction.RIGHT),
            Orientation(Point(16, -9), Direction.RIGHT).move(distance = 0)
        )
        assertEquals(
            Orientation(Point(0, -4), Direction.DOWN),
            Orientation(Point(0, -4), Direction.DOWN).move(distance = 0)
        )
        assertEquals(
            Orientation(Point(14, -5), Direction.LEFT),
            Orientation(Point(14, -5), Direction.LEFT).move(distance = 0)
        )
    }
    ...
    fun testMoveForwardWhileFacingUp() {
        ...
        assertEquals(Orientation(Point(-16, 5), Direction.UP), orientation.move(distance = 3))
        assertEquals(Orientation(Point(-16, -7), Direction.UP), orientation.move(distance = -9))
    }
    ...
    fun testMoveForwardWhileFacingRight() {
        ...
        assertEquals(Orientation(Point(1, 7), Direction.RIGHT), orientation.move(distance = 11))
        assertEquals(Orientation(Point(-24, 7), Direction.RIGHT), orientation.move(distance = -14))
    }
    ...
    fun testMoveForwardWhileFacingDown() {
        ...
        assertEquals(Orientation(Point(0, -6), Direction.DOWN), orientation.move(distance = 5))
        assertEquals(Orientation(Point(0, 2), Direction.DOWN), orientation.move(distance = -3))
    }
    ...
    fun testMoveForwardWhileFacingLeft() {
        ...
        assertEquals(Orientation(Point(12, -3), Direction.LEFT), orientation.move(distance = 2))
        assertEquals(Orientation(Point(26, -3), Direction.LEFT), orientation.move(distance = -12))
    }
