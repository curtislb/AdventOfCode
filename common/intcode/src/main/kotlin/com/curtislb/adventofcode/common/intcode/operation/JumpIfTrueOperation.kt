 ...
 *
 * This operation takes 2 parameters: `A` and `B`. It first checks if the value of `A` is non-zero.
 * If it is, then this operation moves the instruction pointer to the position given by `B`.
 * Otherwise, it advances the pointer as normal.
 */
