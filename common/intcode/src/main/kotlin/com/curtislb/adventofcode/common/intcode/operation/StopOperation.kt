 ...
 *
 * This operation takes no parameters. It indicates that the currently running program should halt
 * by moving its instruction pointer to an invalid position.
 */
