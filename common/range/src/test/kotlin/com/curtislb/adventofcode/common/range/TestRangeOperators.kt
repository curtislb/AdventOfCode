...
class TestRangeOperators {
    ...
    fun testRangeTo() {
        ...
        assertEquals(
            BigIntegerRange(BigInteger("-5"), BigInteger("-2")),
            BigInteger("-5")..BigInteger("-2")
        )
        assertEquals(
            BigIntegerRange(BigInteger("-861"), BigInteger("987")),
            BigInteger("-861")..BigInteger("987")
        )
    }
    ...
    fun testUntil() {
        ...
        assertEquals(
            BigIntegerRange(BigInteger.ZERO, BigInteger.ZERO),
            BigInteger.ZERO until BigInteger.ONE
        )
        assertEquals(
            BigIntegerRange(BigInteger.ONE, BigInteger.ONE),
            BigInteger.ONE until BigInteger.TWO
        )
        assertEquals(
            BigIntegerRange(BigInteger.ZERO, BigInteger.ONE),
            BigInteger.ZERO until BigInteger.TWO
        )
        assertEquals(
            BigIntegerRange(BigInteger.TWO, BigInteger("9")),
            BigInteger.TWO until BigInteger.TEN
        )
        assertEquals(
            BigIntegerRange(BigInteger("-5"), BigInteger("-3")),
            BigInteger("-5") until BigInteger("-2")
        )
        assertEquals(
            BigIntegerRange(BigInteger("-861"), BigInteger("986")),
            BigInteger("-861") until BigInteger("987")
        )
    }
}
