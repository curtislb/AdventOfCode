...
/**
 * Returns the solution to the puzzle for 2021, day 10, part 2.
 *
 * @param inputPath The path to the input file for this puzzle.
 */
fun solve(inputPath: Path = Paths.get("..", "input", "input.txt")): Long? {
    val scorer = SyntaxScorer(inputPath.toFile().readLines())
    return scorer.completionScores.values.toList().medianOrNull()
}
