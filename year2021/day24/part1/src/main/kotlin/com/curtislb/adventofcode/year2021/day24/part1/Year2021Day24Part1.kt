...
the result of the operation is stored (one of `w`, `x`, `y`, or `z`), while `b` can be either a
...
means that when operating MONAD, each input instruction should only ever be given an integer value
of at least 1 and at most 9.
...
package com.curtislb.adventofcode.year2021.day24.part1
