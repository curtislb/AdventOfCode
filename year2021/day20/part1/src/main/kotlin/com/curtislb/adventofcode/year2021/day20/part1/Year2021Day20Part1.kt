...
Every pixel of the infinite output image needs to be calculated exactly based on the relevant pixels
...
/**
 * Returns the solution to the puzzle for 2021, day 20, part 1.
 *
 * @param inputPath The path to the input file for this puzzle.
 * @param iterationCount The number of times to apply the enhancement algorithm to the image.
 */
fun solve(inputPath: Path = Paths.get("..", "input", "input.txt"), iterationCount: Int = 2): Int {
