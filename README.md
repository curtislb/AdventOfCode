...
* [Advent of Code 2023][aoc-2023-link] (Days 1-13)

## Getting Started

### Dependencies

* [Gradle 8.2.1][gradle-link]
* [Java 17][java-link]
* [Kotlin 1.9.21][kotlin-link]
...
This project can be opened with [IntelliJ IDEA][ij-idea-link] and run using the built-in
[Gradle][ij-gradle-link] extension.
...
[gradle-link]: https://docs.gradle.org/8.2.1/release-notes.html
...
[kotlin-link]: https://github.com/JetBrains/kotlin/releases/tag/v1.9.21
