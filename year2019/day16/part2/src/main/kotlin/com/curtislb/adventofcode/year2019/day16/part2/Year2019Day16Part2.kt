 ...
 * @param signalRepeatCount The number of times the base signal is repeated in the input signal.
 * @param offsetDigits The number of digits at the beginning of the original signal that represent
 *  the message offset.
 * @param messageLength The number of digits at the given offset in the final signal that represent
 *  the message.
 */
fun solve(
