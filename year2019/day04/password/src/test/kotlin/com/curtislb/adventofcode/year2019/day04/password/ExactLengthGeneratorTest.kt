...
class ExactLengthGeneratorTest {
    ...
    fun testCountPasswords() {
        ...
        assertEquals(0, ExactLengthGenerator(2).addDigit(7).addDigit(8).addDigit(9).countPasswords())
    ...
    fun testGeneratePasswordSuffixes() {
        ...
        assertEquals(listOf(""), ExactLengthGenerator(1).addDigit(1).generatePasswordSuffixes().toList())
        assertEquals(emptyList(), ExactLengthGenerator(1).addDigit(2).addDigit(3).generatePasswordSuffixes().toList())
        assertContainsExactly(
        ...
        assertEquals(listOf(""), ExactLengthGenerator(2).addDigit(5).addDigit(6).generatePasswordSuffixes().toList())
        assertEquals(
            emptyList(),
            ExactLengthGenerator(2).addDigit(7).addDigit(8).addDigit(9).generatePasswordSuffixes().toList()
        )
        assertEquals(100000, ExactLengthGenerator(5).generatePasswordSuffixes().count())
        assertEquals(10000, ExactLengthGenerator(6).addDigit(9).addDigit(7).generatePasswordSuffixes().count())
    }
}
