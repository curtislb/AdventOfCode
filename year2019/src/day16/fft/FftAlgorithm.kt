...
/**
 * Implementation of the "Flawed Frequency Transmission" (FFT) algorithm for transforming an arbitrary signal.
 *
...
class FftAlgorithm(private val inputSignal: List<Int>) {
    ...
    /**
     * Returns the sequence of coefficients used by the FFT algorithm to transform the signal value at [signalIndex].
     */
