 ...
 * @param maxFunctionCount The maximum number of movement functions for the vacuum robot.
 * @param maxCharCount The maximum number of ASCII characters per line for the vacuum robot.
 */
fun solve(
    inputPath: Path = Paths.get("..", "input", "input.txt"),
    maxFunctionCount: Int = 3,
    maxCharCount: Int = 20
): BigInteger? {
