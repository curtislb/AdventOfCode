...
- Turn 6: The last number spoken, 3 had also been spoken before, most recently on turns 5 and 2. So,
  the 6th number spoken is 5 - 2, 3.
...
Their question for you is: what will be the 2020th number spoken? In the example above, the 2020th
number spoken will be 436.
...
/**
 * Returns the solution to the puzzle for 2020, day 15, part 1.
 *
...
fun solve(inputPath: Path = Paths.get("..", "input", "input.txt")): Int? {
    ...
    val game = MemoryGame(startingNums).apply { playTurns(2020) }
