...
/**
 * A memory game in which new numbers are generated by following a set of rules based on previous
 * numbers.
 *
 * The game begins with a list of starting numbers. Then, each turn consists of considering the
 * latest number:
 *
 * - If that was the first time the number occurred, the next number is 0.
 * - Otherwise, the next number is the turns apart the latest number is from when it was previously
 *   spoken.
 *
