...
more than a trillion valid ways to arrange them! Surely, there must be an efficient way to count the
arrangements.
...
/**
 * Returns the solution to the puzzle for 2020, day 10, part 2.
 *
