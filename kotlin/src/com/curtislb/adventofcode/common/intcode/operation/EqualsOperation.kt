...
/**
 * Represents the equals operation (opcode 8) for an [Intcode] program.
 *
 * This operation takes 3 parameters: `A`, `B`, and `C`. It first checks the condition `A == B`. If the condition is
 * `true`, this operation then stores the value 1 at the position given by `C`. Otherwise, it stores the value 0 at that
 * position.
 */
