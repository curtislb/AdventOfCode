 ...
 *
 * @throws IllegalArgumentException If this number is negative, [position] is negative, [base] is less than 2, or there
 *  is no digit at [position] for this number in the given [base].
 */
fun Int.bigEndianDigit(position: Int, base: Int = 10): Int {
    ...
    require(position < digitCount) { "Integer $this has no big-endian digit at position $position in base $base." }
 ...
 * return 0.
 *
 * @throws IllegalArgumentException If this number is negative, [position] is negative, or [base] is less than 2.
 */
 ...
 * Returns the digit at [position] (from right to left) for this non-negative integer in the given [base].
 */
private fun Int.littleEndianDigitInternal(position: Int, base: Int): Int = (this / base.pow(position)) % base
