...
can't be extra unmatched characters in the message. (For example, aaaabbb might appear to match rule 0 above, but it has
...
/**
 * Returns the solution to the puzzle for 2020, day 19, part 1.
 *
...
fun solve(inputPath: Path = pathToInput(year = 2020, day = 19)): Int {
    ...
    val primaryRule = parseRule(ruleStrings[0]!!, ruleStrings)
