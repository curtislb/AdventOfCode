...
First, you will be prompted for the main movement routine. The main routine may only call the movement functions: A, B,
or C. Supply the movement functions to use as ASCII text, separating them with commas (,, ASCII code 44), and ending
the list with a newline (ASCII code 10). For example, to call A twice, then alternate between B and C three times,
...
number to move forward that many units. Movement functions may not call other movement functions. Again, separate the
...
package com.adventofcode.curtislb.year2019.day17.part2
