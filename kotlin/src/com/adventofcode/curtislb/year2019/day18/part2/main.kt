...
First, the top-right, bottom-left, and bottom-right robots take turns collecting keys a, b, and c, a total of 6 + 6 + 6
= 18 steps. Then, the top-left robot can access key d, spending another 6 steps; collecting all of the keys here takes
a minimum of 24 steps.
...
package com.adventofcode.curtislb.year2019.day18.part2
...
private val INPUT_PATH = pathToInput(year = 2019, day = 18, part = 2)
