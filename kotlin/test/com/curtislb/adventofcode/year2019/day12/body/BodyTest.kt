...
class BodyTest {
    ...
    fun testConstructWithWrongPositionVectorSize() {
        Body(MutableIntVector(0, 1))
    }

    @Test(expected = IllegalArgumentException::class)
    fun testConstructWithWrongVelocityVectorSize() {
        Body(velocity = MutableIntVector(-2, 3, 4, -5))
    }
    ...
    fun testTotalEnergy() {
        ...
        assertEquals(9, Body(position = MutableIntVector(1, 1, 1), velocity = MutableIntVector(1, 1, 1)).totalEnergy)
        assertEquals(36, Body(position = MutableIntVector(3, -2, 1), velocity = MutableIntVector(-1, 2, -3)).totalEnergy)
        assertEquals(110, Body(position = MutableIntVector(-5, 5, 0), velocity = MutableIntVector(8, 0, 3)).totalEnergy)
        assertEquals(
            2250,
            Body(position = MutableIntVector(18, -12, -15), velocity = MutableIntVector(17, 13, -20)).totalEnergy
        )
    }
    ...
    fun testApplyGravity() {
        ...
        body = Body(position = MutableIntVector(-11, -14, 5), velocity = MutableIntVector(18, -5, 16))
        body.applyGravity(body)
        assertEquals(MutableIntVector(-11, -14, 5), body.position)
        assertEquals(MutableIntVector(18, -5, 16), body.velocity)

        body = Body(position = MutableIntVector(-2, 16, 3), velocity = MutableIntVector(-18, -7, 13))
        body.applyGravity(Body(position = MutableIntVector(-11, 16, 11), velocity = MutableIntVector(-8, -7, -1)))
    ...
    fun testApplyVelocity() {
        ...
        body = Body(position = MutableIntVector(-16, 13, -13), velocity = MutableIntVector(0, 19, -9))
        body.applyVelocity()
    ...
    @Test
    fun testCopy() {
        val body = Body(position = MutableIntVector(16, 14, -2), velocity = MutableIntVector(1, -9, 0))
    ...
    fun testEquals() {
        ...
        assertEquals(Body(velocity = MutableIntVector(49, 79, 87)), Body(velocity = MutableIntVector(49, 79, 87)))
        assertEquals(
        ...
        assertNotEquals(
            Body(position = MutableIntVector(-87, 84, -70), velocity = MutableIntVector(-59, -22, 70)),
            Body(position = MutableIntVector(-59, -22, 70), velocity = MutableIntVector(-87, 84, -70))
        )
    }
    ...
    fun testHashCode() {
        val bodies = listOf(
            ...
            Body(position = MutableIntVector(65, -76, 32), velocity = MutableIntVector(-41, -62, 35)),
            Body(position = MutableIntVector(-66, -10, -93), velocity = MutableIntVector(-52, 24, 88))
        )
    ...
    fun testToString() {
        assertEquals(
            ...
            Body(position = MutableIntVector(-8, 10, 11), velocity = MutableIntVector(3, -3, 0)).toString()
        )
    }
}
