...
class OrientationTest {
    @Test fun testMoveForwardZeroDistance() {
        assertEquals(
    ...
    @Test fun testMoveForwardWhileFacingUp() {
    ...
    @Test fun testMoveForwardWhileFacingRight() {
    ...
    @Test fun testMoveForwardWhileFacingDown() {
    ...
    @Test fun testMoveForwardWhileFacingLeft() {
    ...
    @Test fun testTurnTowardSameDirection() {
        assertEquals(
    ...
    @Test fun testTurnTowardDifferentDirection() {
        assertEquals(
